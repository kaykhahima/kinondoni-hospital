...
<head>
    ...
    <title>Latest News - Kinondoni Hospital</title>
                                    ...
                                    <nav class="ast-flex-grow-1 navigation-accessibility" id="site-navigation" aria-label="Site Navigation" itemtype="https://schema.org/SiteNavigationElement" itemscope="itemscope">
                                        <div class="main-navigation">
                                            <ul id="primary-menu" class="main-header-menu ast-nav-menu ast-flex ast-justify-content-flex-end  submenu-with-border">
                                                ...
                                                <li id="menu-item-17" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17"><a href="./">Latest News</a></li>
                                ...
                                <div data-elementor-type="wp-post" data-elementor-id="8" class="elementor elementor-8" data-elementor-settings="[]">
                                    <div class="elementor-inner">
                                        <div class="elementor-section-wrap">
                                                                ...
                                                                <div class="elementor-widget-wrap">
                                                                    <div class="elementor-element elementor-element-3e441ded elementor-widget elementor-widget-heading" data-id="3e441ded" data-element_type="widget" data-widget_type="heading.default">
                                                                        <div class="elementor-widget-container">
                                                                            <h1 class="elementor-heading-title elementor-size-default">Latest News</h1>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <section id="news">
                                                <div class="container pb-0 py-5 my-5 text-center">
                                                    <img width="181" height="65" src="../wp-content/uploads/sites/228/2020/02/mailbox.svg" class="pb-3" alt="mailbox" />
                                                    <h3>NO NEWS YET!</h3>
                                                    <p>Please keep visiting our site to get the latest news from us.</p>

                                                    <div class="elementor-element elementor-element-7f37f0f elementor-mobile-align-center elementor-widget elementor-widget-button pt-4" data-id="7f37f0f" data-element_type="widget" data-widget_type="button.default">
                                                        <div class="elementor-widget-container">
